...
HD_PWD='/home/spixy/Documents/College/EE316/EE316P4/Keyboard/keyboard/keyboard.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log Keyboard_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Keyboard_wrapper.tcl -notrace
