...
HD_PWD='/home/spixy/Documents/College/EE316/EE316P4/Keyboard/keyboard/keyboard.runs/Keyboard_system_ila_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Keyboard_system_ila_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Keyboard_system_ila_0_1.tcl
